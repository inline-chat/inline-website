...
import { PageContainer, PageLongFormContent, PageHeader } from "~/components/Page"
...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "We're commited to protect Inline users' privacy and data while providing a great experience.",
    },
  ]
}
  ...
  return (
    <>
      ...
      <PageContainer>
        ...
        <PageLongFormContent>
          <Markdown remarkPlugins={[remarkGfm]} className="page-content">
            {PRIVACY_POLICY}
          </Markdown>
        </PageLongFormContent>
      </PageContainer>
